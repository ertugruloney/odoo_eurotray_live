...
class Partner(models.Model):
    ...
    taxx = fields.Selection(
        [('istanbul', 'Istanbul'), ('izmir', 'izmir')],
        string="Tax Office", default='istanbul')
    taxx2 = fields.Many2one('tax.office' ,string='Tax Office', domain="[('state_id', '=?', state_id)]")
    is_company = fields.Boolean(string='Is a Company', default=True,
        help="Check if the contact is a company, otherwise it is a person")
    is_turkey = fields.Boolean(string='Is_turkey', default=True,compute='_onchange_country_id')
