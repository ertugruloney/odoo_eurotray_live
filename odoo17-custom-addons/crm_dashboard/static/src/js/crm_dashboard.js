...
export class CRMDashboard extends Component {
    ...
    async onWillStart() {
        ...
        var def14 = jsonrpc('/web/dataset/call_kw/crm.lead/get_count_opportunities', {
                model: "crm.lead",
                method: "get_count_opportunities",
                args: [{}],
                kwargs: {},
            })
            .then(function(res) {
                self.get_count_opportunities = res['count_opportunities'];
            });
        var def15 = jsonrpc('/web/dataset/call_kw/crm.lead/get_expected_revenue', {
                model: "crm.lead",
            ...
            .then(function(res) {
                self.get_expected_revenue = res['expc_revenue'];
            });
